    ...
    public class MainController : Controller
    {
        ...
        public ActionResult About()
        {
            ...
            try
            {
                ...
                SI.DevelopmentHistory += "7.2016/01/25 增加屬性、範本、物件新增編輯時，使用系統設定的雜湊演算法進行資料HASH計算並儲存，確保資料異動時不會被竄改(0.5.0.20160126)\r\n";
                SI.DevelopmentHistory += "8.2016/03/31 完成批次匯入組態資料功能excel2SQL(0.5.1.20160331)\r\n";
                ...
                SI.DevelopmentHistory += "12.2016/09/10  支援屬性可設定為搜尋條件(0.6.2.20160910)\r\n";
                SI.DevelopmentHistory += "13.2016/10/21  完成範本關係管理功能開發(0.7.0.20161021)\r\n";
